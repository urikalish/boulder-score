const config = {
    ...
    levels: [
        ...
        },
        {
            v: 6,
            points: 700,
            problems: [27, 26, 25, 24],
        },
        {
            v: 5,
            points: 600,
            problems: [23, 22, 21, 20, 19],
        },
        {
            v: 4,
            points: 500,
            problems: [18, 17, 16, 15, 14],
        },
        {
            v: 3,
            points: 400,
            problems: [13, 12, 11, 10, 9],
        },
        {
            v: 2,
            points: 300,
    ...
    config.levels.forEach(l => {
        l.problems.forEach(p => {
            ...
            for (let a = 1; a <= config.maxAttemptsPerProblem; a++) {
                ...
                attemptElm.dataset.text = a.toString();
                ...
                const randomRotate = Math.floor(Math.random()*30) + 5;
